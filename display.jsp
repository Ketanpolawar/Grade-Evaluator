<%--
 Document : display1
 Created on : 12 Feb, 2023, 3:20:23 PM
 Author : Ketan
--%>
...
transform: scale(.6);
 ...
 <body>
 <% String grade;Integer rolln;%>
 <%
 grade=request.getParameter("grade2");
 PreparedStatement ps=null;
 rolln=0;
 String sql=("select * from Class where grade=?");
 if(grade!=null)
 {
 try{
 Connection 
con=DriverManager.getConnection("jdbc:derby://localhost:1527/Student","Student","Student");
 ...
 //if(rs.next())
 {
 rolln=rs.getInt("roll");
 out.println("roll no is"+rolln+"<br>"); 
 }
// else
// {
// out.println("no studet with above grade:");
// }
 }
 }
